              ...
              <Card className="border-primary/20 bg-primary/5 hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <img 
                        src="https://d2xsxph8kpxj0f.cloudfront.net/310519663744157916/CHf9MxtAH88X58LKP9LAzj/ubereats-badge-LgEFc7RD4ZwUYq55ozzjYa.webp" 
                    ...
                    >
                      <img 
                        src="https://d2xsxph8kpxj0f.cloudfront.net/310519663744157916/CHf9MxtAH88X58LKP9LAzj/mrd-badge-GrA6zNwyLymjC8xZnmqfq6.webp" 
                        alt="Order on Mr D" 
                        className="w-full h-auto rounded-lg shadow-lg hover:shadow-xl transition-shadow"
                      />
                    </a>
